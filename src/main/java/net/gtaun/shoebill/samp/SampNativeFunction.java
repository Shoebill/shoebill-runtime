...
public final class SampNativeFunction
{
	...
	public static native int getPlayerAnimationIndex(int playerid); // return
																	// the index
																	// of any
																	// running
																	// applied
																	...
																	// none are
																	// running )
	// public static native int getAnimationName( int index, String animlib, int
	// len1, String animname, int len2 ); // get the animation lib/name for the
	...
	public static native int getVehicleComponentInSlot(int vehicleid, int slot); // There
																					// is
																					// 1
																					// slot
																					// for
	...
	public static native int getVehicleComponentType(int component); // Find
																		// CARMODTYPE_*
																		// for
																		// component
																		// id
	
	public static native void repairVehicle(int vehicleid); // Repairs the
															// damage model and
															// resets the health
